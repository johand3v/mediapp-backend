...
public class ConsultaController {
	...
	@PostMapping
	public ResponseEntity<Consulta> registrar(@RequestBody @Valid ConsultaListExamenDTO dto) throws Exception {
	...
	@PutMapping
	public ResponseEntity<Consulta> modificar(@RequestBody @Valid Consulta t) throws Exception {
	...
	public ResponseEntity<Consulta> listarPorId(@PathVariable Integer id) throws Exception {
		...
		if (obj == null) {
			throw new ModelNotFoundException("Consulta no encontrado con el ID " + id);
		}
	...
	public EntityModel<Consulta> listarHateosPorId(@PathVariable Integer id) throws Exception {
		...
		recurso.add(link2.withRel("consulta-recurso1"));
		return recurso;
	}
